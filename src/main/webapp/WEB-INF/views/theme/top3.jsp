	  	...
	  	<div class="modalimgbox">
  			<ul class="top3img">
	  			<c:choose>
					...
					<c:otherwise>
						<li style="margin: 20px;"><img class="gold" src="image/gold.png" /><div class="polaroid"><img src="image/WhiteEmptyBox.jpg"/></div></li>
					</c:otherwise>
	  			</c:choose>
	  			<c:choose>
					...
					<c:otherwise>
						<li style="margin: 20px;"><img class="silver" src="image/silver.png" /><div class="polaroid"><img src="image/WhiteEmptyBox.jpg"/></div></li>
					</c:otherwise>
	  			</c:choose>
	  			<c:choose>
					...
					<c:otherwise>
						<li style="margin: 20px;"><img class="bronze" src="image/bronze.png" /><div class="polaroid"><img src="image/WhiteEmptyBox.jpg"/></div></li>
					</c:otherwise>
	  			</c:choose>
  			</ul>
  			<div class="top3name">
